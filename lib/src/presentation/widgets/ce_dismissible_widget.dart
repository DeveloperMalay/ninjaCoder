...
class CEDismissibleWidget extends StatefulWidget {
  const CEDismissibleWidget({
    super.key,
    required this.c,
    required this.data,
  ...
  @override
  State<CEDismissibleWidget> createState() => _CEDismissibleWidgetState();
}

class _CEDismissibleWidgetState extends State<CEDismissibleWidget> {
  @override
